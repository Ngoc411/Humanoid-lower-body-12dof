...
/**
  ...
  *
  * SPI1  — MT6816 encoder, 3-wire (1-LINE) half-duplex
  *           PB3 SCK | PB5 MOSI/SIO  (PB4 MISO not connected in 3-wire)
  *           PB6 NSS software GPIO
  *           DMA1_Ch1 RX, DMA1_Ch2 TX
  *
  * SPI3  — DRV8323SRTAT gate driver, 4-wire polling
  *           PC10 SCK | PC11 MISO | PC12 MOSI
  *           PD2 NSS software GPIO (no DMA)
  *
  ******************************************************************************
  */
