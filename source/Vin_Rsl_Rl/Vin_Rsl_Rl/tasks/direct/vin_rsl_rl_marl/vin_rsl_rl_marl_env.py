...
from .vin_rsl_rl_marl_env_cfg import VinRslRlMarlEnvCfg


class VinRslRlMarlEnv(DirectMARLEnv):
    cfg: VinRslRlMarlEnvCfg

    def __init__(self, cfg: VinRslRlMarlEnvCfg, render_mode: str | None = None, **kwargs):
